...
while bulls_count < 4 && user_tries < 7
  ...
  user_num, user_position = "",""

  puts "QQQ after parallel assignment to empty strings"
  puts "QQQ debug: user_num is: #{user_num.inspect}"

  puts "QQQ debug: user_position is: #{user_position.inspect}"
  print user_position
  ...
  puts "QQQ debug: user_input is: #{user_input.inspect}"

  user_num, user_position = user_input.split

  puts "QQQ after split method"
  puts "QQQ debug: user_num is: #{user_num.inspect}, user_position is: #{user_position.inspect}"
